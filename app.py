...
.login-container{max-width:450px;width:100%;background:#fff;padding:55px;border-radius:25px;box-shadow:0 30px 100px rgba(0,0,0,0.25);text-align:center;color:#2c3e50;}
...
<p style="margin-top:35px;font-size:15px;color:#666;">Пароли защищены и хешируются</p>
</div></body></html>'''
